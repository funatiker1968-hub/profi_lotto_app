...
// Exit Handler für Back-Button mit Bestätigungsdialog
...
class __ExitHandlerState extends State<ExitHandler> {
  ...
  Future<bool> _onWillPop() async {
    ...
    final isDoublePress = _lastPressTime != null && 
        currentTime.difference(_lastPressTime!) < Duration(seconds: 2);
  ...
  Future<bool?> _showExitDialog(BuildContext context) async {
    return await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Möchten Sie die Lotto App wirklich verlassen?'),
        actions: [
          TextButton(
